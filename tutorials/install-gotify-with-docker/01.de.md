...
* Wähle im Menü "Users" aus.
* Klicke auf das Bearbeitungs-Symbol neben dem Benutzer `admin`.
* Gib ein neues Passwort ein und bestätige es.
* Klicke auf "Update", um die Änderung zu speichern.
...
* Klicke in der Gotify-Weboberfläche in der linken Seitenleiste auf "Apps".
